...
public class GuestUserShortList extends BaseClass{
    ...
    public void applyForJobAsRegisteredUser(
        ...
        homePage.jobShortlist1().click(); // Click shortlist on job card
        Thread.sleep(4000); // Wait for modal

        page.locator("//input[@name='userName']").fill(name);
        page.locator("//input[@placeholder='Mobile*']").fill(mailphone);
     ...
     // Handle OTP entry
        ...
        Thread.sleep(3000); // Stabilize for screenshots
