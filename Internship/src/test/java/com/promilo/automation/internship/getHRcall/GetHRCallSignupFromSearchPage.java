...
public class GetHRCallSignupFromSearchPage extends Baseclass {
	

    @Test
    public void  GetHRCallSignup() throws InterruptedException {
        ...
        callback.entermobileNumber(mobileNumber);
        callback.enterEmail(email);
        callback.industryDropdownClick();
        callback.clickValue();
        callback.selectValueIndustry();
        callback.closeIndustryDropdown();
