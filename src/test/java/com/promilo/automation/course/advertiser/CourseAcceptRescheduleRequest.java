...
public class CourseAcceptRescheduleRequest extends BaseClass {
    ...
    public void CallbackOrTalktoExpertApprovefunctionalityTest() throws InterruptedException, IOException {
        ...
        for (int i = 1; i < rowCount; i++) {
            ...
            try {
                ...
                System.out.println("success  Popup  "   +successPopup);
                
                // Print success toaster text
                page.waitForTimeout(3000);
                String successMsg = page.locator("[class='font-14 text-center']").textContent().trim();
