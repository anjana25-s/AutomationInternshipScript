...
public class WhenUsersRescheduleRequestIsAccepted extends BaseClass {

    ExtentReports extent = ExtentManager.getInstance();
    ExtentTest test;

    private static final Logger logger = LogManager.getLogger(WhenUsersRescheduleRequestIsAccepted.class);
    ...
    private void applyJobDetailsFlow(Page page, String name, String otp, String mailphone) throws Exception {
        ...
        page3.locator("//button[text()='Accept Request']").click();
        test.pass("✅ Advertiser accepted Reschedule Request");
  System.out.println( page3.locator("//div[@id='interest-job-accept-success']").textContent()  );
