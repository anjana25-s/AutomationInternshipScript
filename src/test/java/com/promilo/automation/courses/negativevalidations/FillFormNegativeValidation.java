...
public class FillFormNegativeValidation extends BaseClass {
    ...
    public void TaltoExpertIntrest(
        ...
        Talktopage.locator("//span[text()='Fill Application']").click();
        ...
        Talktopage.locator("//button[text()='Fill Application']").click();
