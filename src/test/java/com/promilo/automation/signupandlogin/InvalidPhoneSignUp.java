...
public class InvalidPhoneSignUp extends BaseClass {
    ...
    public void signupWithExistingUserMail() throws Exception {
        ...
        ExtentTest test = extent.createTest("InvalidPhoneSignUp");
        ...
        Set<String> signupKeywords = new HashSet<>(Arrays.asList("InvalidPhoneSignup"));
