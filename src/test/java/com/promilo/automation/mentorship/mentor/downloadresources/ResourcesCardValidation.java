...
public class ResourcesCardValidation extends BaseClass {
    ...
    public void AcceptVideoServiceRequestTest() throws Exception {
     ...
     // ========================= SECTION: Excel Initialization =========================
        ...
        for (int i = 1; i <= rowCount; i++) {
            ...
            String actualMenteeName=  acceptVideoRequest.resourcesmenteeName().textContent().trim();
            ...
            String actualChosenLanguage=acceptRequest.ResourcesCompletedTag().textContent().trim();
            assertEquals(actualChosenLanguage, "Completed");
            
            
            
            String actualMoney=acceptRequest.resourceMoney().textContent().trim();
