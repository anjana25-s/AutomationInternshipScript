package com.promilo.automation.mentorship.mentee.askquery.negativevalidations;
...
public class AskQueryNegativeValidations extends BaseClass {
    ...
    // =========================================================
    @DataProvider(name = "ErrorMessagesValidation")
    ...
    //                🔹 MAIN TEST SECTION
    // =========================================================
    @Test(dataProvider = "ErrorMessagesValidation")
    public void mentorshipShortListFunctionalityTest(ExcelUtil excel) throws Exception {
        ...
        Locator askYourQuery=  serviceClick.askYourQuery().first();
        askYourQuery.scrollIntoViewIfNeeded();
        askYourQuery.click();
...
//click ask query button again to trigger validation message
serviceClick.askYourQuery().nth(2).click();
