...
public class CourceAskus extends Baseclass {
	 ...
	 @Test
	    public void TaltoExpert() throws InterruptedException, IOException {
	        ...
	        for (int i = 1; i < rowCount; i++) {
	            ...
	            page.locator("#feedbackDetails").fill("something");
	         ...
	         notification.click();
	       System.out.println(page.locator("//h6[contains(text(),'🎉 Great Choice! You’ve just shortlisted ')]").textContent());  
