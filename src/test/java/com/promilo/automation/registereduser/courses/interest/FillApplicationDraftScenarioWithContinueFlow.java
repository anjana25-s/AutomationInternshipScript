...
public class FillApplicationDraftScenarioWithContinueFlow extends BaseClass {
     ...
     // ======== Load Excel ========
        ...
        page.waitForTimeout(2000);         
             ...
             // Open new tab for Mailosaur UI
                ...
                page.locator("//img[@class='close-icon']").click();
                page.locator("//button[text()='Save as draft']").click();
                ...
                page.locator("[class='application-action-btn']").click();
                ...
                fillApplication.payButton().first().click();
                ...
                page.locator("iframe").contentFrame().getByTestId("contactNumber").fill("9000087681");
                page.locator("iframe").contentFrame().getByTestId("nav-sidebar").locator("div").filter(new Locator.FilterOptions().setHasText("Wallet")).nth(2).click();
                Page page1 = page.waitForPopup(() -> {
                  page.locator("iframe").contentFrame().getByRole(AriaRole.BUTTON, new FrameLocator.GetByRoleOptions().setName("PhonePe PhonePe")).click();
                });
                page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Success")).click();
                page1.close();    
                ...
                page.locator("//a[text()='My Application.']").click();
                  ...
                  page.waitForTimeout(3000);
                  String campaignName1=fillFormValidation.campaignName().textContent().trim();
                  assertEquals(campaignName1, "Golden Institute of Technology");
                  
                  
                  String location1= fillFormValidation.location().textContent().trim();
                  assertEquals(location1, "Nandyal");
                  
                  
                  String courseName1= fillFormValidation.courseName().textContent().trim();
                  assertEquals(courseName1, "MBA");
                  
                  String serviceName1= fillFormValidation.serviceName().textContent().trim();
                  assertEquals(serviceName, "Application");
