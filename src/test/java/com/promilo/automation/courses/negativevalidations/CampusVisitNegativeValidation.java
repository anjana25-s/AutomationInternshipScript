...
public class CampusVisitNegativeValidation extends Baseclass {
    ...
    public void TaltoExpertIntrest(
        ...
        Talktopage.locator("//span[text()='Campus Visit']").click();
        ...
        Talktopage.locator("//button[text()='Book Visit']").click();
