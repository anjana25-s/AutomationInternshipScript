...
public class FreeVideoCounsellingAlreadyInterestShwon extends BaseClass {

    @Test
    public void FreeVideoCounsellingAlreadyInterestShwonTest() throws InterruptedException, IOException {
        ...
        for (int i = 1; i < rowCount; i++) {
            ...
            page.locator("[class='card-content-header-text fw-bolder mb-0 text-wrap pointer text-truncate']").click();
            
            
            MentorshipBookMeetingPageObjects po1 = new MentorshipBookMeetingPageObjects(page);

            fvcPage.freeVideoCounsellingBtn().click();


            String currentMonth1 = po1.currentMonth().textContent().trim();
            ...
            Locator dateElement1 = po1.availableDate();
            dateElement1.click();
            BaseClass.selectedDate = dateElement1.innerText().split("\\s+")[0].trim();

            Locator timeElement1 = po1.firstTimeSlot();
            timeElement1.click();
            BaseClass.selectedTime = timeElement1.innerText();
           ...
           page.locator("//button[text()='Next']").click();
            ...
            String toasterValidation=page.locator("//div[text()='You already shown interest on this campaign.']").textContent().trim();
