    ...
    public void AcceptVideoServiceRequestTest() throws Exception {
        ...
        for (int i = 1; i < rowCount; i++) {
            ...
            try {
                ...
                System.out.println(acceptVideoRequest.videoCallstatusTag().first().textContent()); 
                System.out.println(page.locator("(//div[@class='preferance-header-text'])[1]").textContent()); 
                System.out.println(page.locator("//div[@class='text-gray-600 category-text-interest-card text-truncate text-wrap']").first().textContent()); 
                System.out.println(page.locator("//div[@class='category-text-interest-card text-truncate text-wrap']").textContent()); 
