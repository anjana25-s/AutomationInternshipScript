...
public class UserRequestisRejectedByTheAdvertiser extends BaseClass {
   ...
   public void applyForJobAsRegisteredUser(Page page, String inputvalue, String password, String name, String otp, String mailphone) throws Exception {
       ...
       page2.locator("//button[text()='Log in']").click();
       ...
       page.locator("//span[text()='Hi ']").first().textContent();
       page.locator("(//p)[7]").textContent();
       page.locator("(//p)[8]").textContent();
       page.locator("(//p)[9]").textContent();
       page.locator("(//p)[16]").textContent();
       page.locator("//td[@style='padding-left: 10px']");
       
       
       EmailnotificationsShortlisted components= new EmailnotificationsShortlisted(page2);
       components.facebook();
