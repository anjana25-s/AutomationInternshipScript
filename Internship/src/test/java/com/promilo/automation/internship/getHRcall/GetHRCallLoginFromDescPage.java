...
public class GetHRCallLoginFromDescPage extends Baseclass {
	

    @Test
    public void GetHRCallLoginDescPage() throws InterruptedException {
        ...
        String mobileNumber = TestAccountStore.getUsername();
        ...
        callback.clickLogin();
        callback.enterEmailId(mobileNumber);
