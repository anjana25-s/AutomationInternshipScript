...
public class myAudiencePage {
	...
	public myAudiencePage(Page page) {
		...
		this.functionalArea= page.locator("//div[@class='form-floating override-mb-0 mb-3']//div[@class='dropdown-heading']");
		...
		this.audienceLocation= page.locator("//div[@class='mb-1 audience-industry-multiselect industry-name-dropdown select-all bottom-option-dropdown col-md-6']//div[@class='form-floating override-mb-0 mb-3']//div//div[@class='search-wrapper searchWrapper ']");
		this.relevantTitle= page.locator("div[class='mb-1 audience-industry-multiselect industry-name-dropdown bottom-option-dropdown col-md-6'] div[class='form-floating override-mb-0 mb-3'] div div[class='search-wrapper searchWrapper ']");	
		this.audiencelocationOption= page.locator("//li[text()='Ahmedabad']");
		 this.Keywords= page.locator("input[placeholder='Add new keyword here']");
		   this.MinAge=      page.locator("form-floating.override-mb-0 > .react-select-container > .react-select__control > .react-select__value-container > .react-select__input-container").first();
	...
	public Locator functionalArea() {return functionalArea;}
	public Locator functionalareaOption() {return functionalareaOption;}
	public Locator relevantTitle() {return relevantTitle;}
	public Locator relevantTitleOption() {return relevantTitleOption;}
	public Locator audienceLocation() {return audienceLocation;}
	public Locator audiencelocationOption() {return audiencelocationOption;}
