...
public class MailRegisteredFreeVideoCounselling   extends BaseClass{
    ...
    public void applyForJobWithInvalidData() throws Exception {
     ...
     // ✅ Invalid inputs validation
        ...
        Locator counsellingBtn = page.locator("//button[@class='submit-btm-askUs btn btn-primary']");
        ...
        test.info("🎯 Clicked 'Start Counselling' button");
