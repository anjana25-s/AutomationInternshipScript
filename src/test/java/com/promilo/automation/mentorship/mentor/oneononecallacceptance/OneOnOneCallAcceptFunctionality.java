    ...
    public void AcceptVideoServiceRequestTest() throws Exception {
        ...
        for (int i = 1; i < rowCount; i++) {
            ...
            try {
                ...
                // Accept One-on-One Call request
                ...
                advertiserLanding.dismissPopup();
                ...
                MyResumePage advertiserMenu = new MyResumePage(advertiserPage);
                advertiserMenu.Mystuff().click();
                advertiserMenu.MyAccount().click();

                MentorMyBilling menteeBilling = new MentorMyBilling(advertiserPage);
                menteeBilling.myBillingButton().click();
                String billingText = menteeBilling.billingData().textContent();
