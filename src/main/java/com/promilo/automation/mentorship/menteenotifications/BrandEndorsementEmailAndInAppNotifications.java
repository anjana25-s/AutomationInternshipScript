...
public class BrandEndorsementEmailAndInAppNotifications {
	...
	public BrandEndorsementEmailAndInAppNotifications(Page page) {
		...
		this.page = page;
		this.brandEndorsementInAppNotifcation = page
				.locator("(//div[h6[contains(text(),'Brand Endorsement Form Submitted')]]/p)[1]");
		this.brandEndorsementEmailNotifcation = page
				.locator("//p[text()='Your Brand Endorsement Request form to assignment has been submitted']");
		...
		this.brandEndorsementRejectedInAppNotification = page
				.locator("//h6[contains(text(),'Your request was not accepted by ')]");
		this.brandEndorsementRejectedEmailNotification = page.locator("//p[contains(text(),'has been Declined')]");

	}

	public Locator brandEndorsementInAppNotifcation() {
		return brandEndorsementInAppNotifcation;
	}

	public Locator brandEndorsementEmailNotifcation() {
		return brandEndorsementEmailNotifcation;
	}

	public Locator brandEndorsementgreetingsText() {
		return brandEndorsementgreetingsText;
	}

	public Locator brandEndorsementThankYouText() {
		return brandEndorsementThankYouText;
	}

	public Locator brandEndorsementIntrestText() {
		return brandEndorsementIntrestText;
	}

	public Locator brandEndorsementMeantimeText() {
		return brandEndorsementMeantimeText;
	}

	public Locator brandEndorsementPendingButton() {
		return brandEndorsementPendingButton;
	}

	public Locator brandEndorsementViewProfileButton() {
		return brandEndorsementViewProfileButton;
	}

	public Locator brandEndorsementRejectedInAppNotification() {
		return brandEndorsementRejectedInAppNotification;
	}

	public Locator brandEndorsementRejectedEmailNotification() {
		return brandEndorsementRejectedEmailNotification;
	}
