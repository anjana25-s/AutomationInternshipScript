...
public class CourseFeedbackNegativeAutomation extends BaseClass {
    ...
    public void TaltoExpertIntrest(
        ...
        Locator fillFeedbackText=Talktopage.locator("//textarea[@placeholder='Write a feedback']");
        fillFeedbackText.fill("Something");
        
        Talktopage.locator("[class='feedback-save-btn']").click();
        fillFeedbackText.fill("");
        
        
        Talktopage.locator("//button[text()='Submit']").nth(1).click();
