...
public class BookMeetingWithInvalidOtp extends BaseClass {
    ...
    public void applyForJobTestFromExcel(
        ...
        try {
            ...
            // Step 1: Close landing page popup if present
            ...
            // Step 5: Fill in valid Name, random Phone & Email
            BookMeetingErrorMessagesAndToasters err = new BookMeetingErrorMessagesAndToasters(page);
            err.nameTextField().fill("karthik");

            int randomNum = (int) (Math.random() * 90000) + 10000;
            mobile = "90000" + randomNum;
            Email = "testuser-" + randomNum + "@mailosaur.net";
            ...
            for (int j = 0; j < 4; j++) {
                ...
                if (!filled) throw new RuntimeException("❌ Failed to enter OTP digit: " + (j + 1));
            }
