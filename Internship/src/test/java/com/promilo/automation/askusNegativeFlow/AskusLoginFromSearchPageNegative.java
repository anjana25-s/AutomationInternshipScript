...
public class AskusLoginFromSearchPageNegative extends Baseclass {
	

    @Test
    public void AskusLoginFromSearchPage() throws InterruptedException {
       ...
       askUsPage.clickOnSendVerificationButton();
       
    // ---------- LOGIN USING UTILITY ----------
       String savedMobile = TestAccountStore.getUsername();
       String invalidOtp = SignUpUtility.generateInvalidOtp();
      
       askUsPage.enterEmailId(savedMobile);
       askUsPage.clickOnSendVerificationButton();
