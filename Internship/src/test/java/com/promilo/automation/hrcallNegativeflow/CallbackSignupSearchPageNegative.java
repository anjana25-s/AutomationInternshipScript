...
public class CallbackSignupSearchPageNegative extends Baseclass {
	

    @Test
    public void CallbackSignupSearchPage() throws InterruptedException {
       ...
       String otp1 = SignUpUtility.getFixedOtp(); 
       String invalidOtp1 = SignUpUtility.generateInvalidOtp();
