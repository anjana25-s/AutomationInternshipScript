...
public class ServicesPage {
	...
	public ServicesPage(Page page) {
		...
		this.langauges = page
				.locator("//div[@class='rmsc service-react-multi-select font-12']//div[@class='dropdown-heading']");
		...
		this.videoDuration = page
				.locator("//div[@id='video_duration']//div[@class='react-select__input-container css-19bb58m']");
		this.deliveryTime = page
				.locator("//div[@id='delivery_time']//div[@class='react-select__input-container css-19bb58m']");

	}

	public Locator oneonecall() {
		return oneonecall;
	}

	public Locator videoCall() {
		return videoCall;
	}

	public Locator askQuery() {
		return askQuery;
	}

	public Locator resources() {
		return resources;
	}

	public Locator brandEndoursement() {
		return brandEndoursement;
	}

	public Locator personalizedVideo() {
	...
	public Locator langauges() {
		return langauges;
	}

	public Locator serviceFee() {
		return serviceFee;
	}

	public Locator evaluate() {
		return evaluate;
	}

	public Locator addService() {
		return addService;
	}

	public Locator noserviceAdded() {
		return noserviceAdded;
	}

	public Locator saveAndNextButton() {
		return saveAndNextButton;
	}

	public Locator serviceCard() {
		return serviceCard;
	}

	public Locator calenderButton() {
		return calenderButton;
	}

	public Locator Monday() {
		return Monday;
	}

	public Locator Tuesday() {
		return Tuesday;
	}

	public Locator Wednsday() {
		return Wednsday;
	}

	public Locator Thursday() {
		return Thursday;
	}

	public Locator Sunday() {
		return Sunday;
	}

	public Locator Friday() {
		return Friday;
	}

	public Locator Saturday() {
		return Saturday;
	}

	public Locator plusIcon() {
		return plusIcon;
	}
	...
	public Locator uploadFile() {
		return uploadFile;
	}

	public Locator videoDuration() {
		return videoDuration;
	}

	public Locator deliveryTime() {
		return deliveryTime;
	}
}
